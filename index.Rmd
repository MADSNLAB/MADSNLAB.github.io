...
FOTO.RGB = paste0("<a href='",Anomalias$FOTO.RGB,"'>",Anomalias$FOTO.RGB,"</a>")
FOTO.ID = Anomalias$FOTO.ID
Deteccion = paste0("<a href='",Anomalias$DETECCION,"'>",Anomalias$DETECCION,"</a>")
Geometry =paste0(Anomalias$geometry)

anomalias_dt = data.frame(Name, Descriptio, FOTO.RGB, FOTO.ID, Deteccion, Geometry)
